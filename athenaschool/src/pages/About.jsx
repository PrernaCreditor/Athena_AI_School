    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="pt-24 py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl transform rotate-1 opacity-10"></div>
          <div className="relative z-10">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">About Our School</h1>
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto mb-8 font-light">Discover our commitment to excellence in British curriculum education</p>
            
            <div className="inline-flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 text-white p-1 rounded-full mt-8">
              <div className="bg-white bg-opacity-20 backdrop-blur-sm p-1 rounded-full">
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-xl p-8 text-white transform hover:-translate-y-2 transition-all duration-300">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">British Standards</h3>
              <p className="text-gray-600">Rigorous academic standards following the UK curriculum framework</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">Highly qualified educators with extensive experience in online learning</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">Cutting-edge technology platforms for immersive learning experiences</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg text-center group hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-600">Connect with peers from diverse backgrounds worldwide</p>
            </div>
          </div>
        </div>
        
        <div className="mb-20">
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-1 mb-12">
            <div className="bg-white rounded-3xl p-8">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-8">Our Educational Philosophy</h2>
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-1">
            <div className="bg-white rounded-3xl p-8">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">Our Learning Methodology</h2>
