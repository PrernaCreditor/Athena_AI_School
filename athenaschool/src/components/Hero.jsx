...
function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen bg-gray-50 overflow-hidden flex items-center py-12 px-4 md:px-8 pt-24">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <p className="text-xl md:text-2xl text-slate-700 mb-8 max-w-lg mx-auto lg:mx-0">
            Personalized online schooling designed for the modern learner
          </p>
          <p className="text-slate-600 mb-10 max-w-xl mx-auto lg:mx-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <button 
              className="bg-blue-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl"
              onClick={scrollToEnquiry}
            >
              Enquire Now
            </button>
            <button className="px-8 py-4 rounded-full border-2 border-gray-300 text-slate-700 font-semibold text-lg hover:bg-gray-50 transition-colors">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="relative flex justify-center">
          <div className="relative w-full max-w-lg h-96 md:h-[450px]">
            ...
            <div className="absolute top-[40%] left-[30%] transition-transform duration-1000 hover:scale-110">
              <div className="w-10 h-10 rounded-full bg-sky-500 flex items-center justify-center text-white font-bold">B</div>
            </div>
            ...
            <div className="absolute top-[30%] left-[70%] transition-transform duration-1000 hover:scale-110">
              <div className="w-10 h-10 rounded-full bg-blue-700 flex items-center justify-center text-white font-bold">D</div>
            </div>
            <div className="absolute top-[70%] left-[85%] transition-transform duration-1000 hover:scale-110">
              <div className="w-10 h-10 rounded-full bg-blue-800 flex items-center justify-center text-white font-bold">E</div>
            </div>
            
            {/* Central focal point */}
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-full bg-gradient-to-r from-blue-600 to-sky-700 flex items-center justify-center shadow-2xl animate-pulse">
